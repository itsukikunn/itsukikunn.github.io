...
<body>
  ...
  <nav class="navbar-up" id="side-bar">
    ...
    <div class="navhead">
        ...
        <div id="navbar-list">
            <a href="home.php" class="dec-navbar">Home</a>
  ...
  <div class="products">
    ...
    <div class="product-list">
        ...
        <img src="madu5.jpg" alt="Madu Hutan Apis Mellifera 250 ml">
            <h3>Madu Hutan Apis Mellifera 250 ml</h3>
            <p class="price">Rp 85.000</p>
            <a href="" class="btn-buy">Buy Now</a>
        </div>
        <div class="product-item">
            <img src="madu2.jpg" alt="Madu Hutan Apis Dorsata 100ml">
            <h3>Madu Hutan Apis Dorsata 100ml</h3>
            <p class="price">Rp 50.000</p>
            <a href="" class="btn-buy">Buy Now</a>
        </div>
        <div class="product-item">
            <img src="madu3.jpg" alt="Madu Kelulut Trigona 250 ml">
        ...
        <br>
        <div class="product-item">
            <img src="madu4.jpg" alt="Madu Hutan Apis Mellifera 450 ml">
            <h3>Madu Hutan Apis Mellifera 450 ml</h3>
            <p class="price">150.000</p>
            <a href="" class="btn-buy">Buy Now</a>
        </div>
        <div class="product-item">
            <img src="madu1.jpg" alt="Madu Hutan Apis Dorsata 250ml">
