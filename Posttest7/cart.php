...
$query = "SELECT * FROM cart WHERE nama_produk LIKE '%$search%'";
...
if (isset($_GET['ajax']) && $_GET['ajax'] == 'true') {
    ...
    <?php else: ?>
        <p>Produk tidak ditemukan atau keranjang belanja kosong.</p>
    <?php endif;
    exit;
}
?>
...
<body>
    <div class="cart-container">
        ...
        <form action="" method="GET" class="cart-form">
            <input type="text" id="search-input" name="search" placeholder="Cari produk..." value="<?php echo htmlspecialchars($search); ?>" class="search-input">
        </form>
        <div id="cart-results">
